...
flags = tf.app.flags
flags.DEFINE_string(
    'model_dir', 'models/research/object_detection/obRec/training', 'Path to output model directory '
    'where event and checkpoint files will be written.')
flags.DEFINE_string('pipeline_config_path', 'models/research/object_detection/obRec/pipeline.config', 'Path to pipeline config file.')
